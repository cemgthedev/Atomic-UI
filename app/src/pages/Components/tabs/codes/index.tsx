  ...
  <TabsContent value='visao-geral'>
    <Card>
      <CardHeader>
        ...
        <Text>
          Visualize suas principais métricas e as atividades recentes dos seus
          projetos. Acompanhe o progresso de todos os projetos ativos em um só
          lugar.
        </Text>
      </CardHeader>
  ...
  <TabsContent value='analises'>
    <Card>
      <CardHeader>
        ...
        <Text>
          Acompanhe métricas de desempenho e engajamento dos usuários. Monitore
          tendências e identifique oportunidades de crescimento.
        </Text>
      </CardHeader>

      <CardContent className='text-sm text-muted-foreground'>
        As visualizações de página aumentaram 25% em relação ao mês passado.
      </CardContent>
    </Card>
  </TabsContent>
  ...
  <TabsContent value='relatorios'>
    <Card>
      <CardHeader>
        ...
        <Text>
          Gere e faça o download de relatórios detalhados. Exporte dados em
          diferentes formatos para análise.
        </Text>
      </CardHeader>
  ...
  <TabsContent value='configuracoes'>
    <Card>
      <CardHeader>
        ...
        <Text>
          Gerencie as preferências e opções da sua conta. Personalize a
          experiência de acordo com as suas necessidades.
        </Text>
      </CardHeader>
...
export const tabsVariantsExample = `<Tabs defaultValue='primary' className='w-[700px]'>
  <TabsList className='flex flex-wrap'>
    {([
      ...
      <TabsTrigger key={variant} value={variant} variant={variant}>
        {variant}
      </TabsTrigger>
    ))}
  </TabsList>
...
export const tabsVerticalExample = `<Tabs defaultValue='perfil' orientation='vertical' className='w-full'>
...
export const tabsTriggerPropertiesExample = `<Tabs defaultValue='primary' className='w-full'>
  <TabsList className='flex flex-wrap'>
    ...
    <TabsTrigger value='secondary' variant='secondary' size='md'>
      Secondary
    </TabsTrigger>
