...
import {
  labelExample,
  labelPropertiesExample,
  labelSizesExample,
  labelVariantsExample,
} from "@/pages/Components/label/codes";
import { labelSourceCode } from "@/pages/Components/label/codes/source-code";
...
export const sectionLinks: UrlProps[] = [
  {
    name: "Importação",
    href: `/${urls.components}/${urls.label}#importacao`,
  },
  {
    name: "Variantes",
    href: `/${urls.components}/${urls.label}#variantes`,
  },
  {
    name: "Tamanhos",
    href: `/${urls.components}/${urls.label}#tamanhos`,
  },
  {
    name: "Propriedades",
    href: `/${urls.components}/${urls.label}#propriedades`,
  },
];
    ...
    <>
      <section className="scroll-progress min-h-[calc(100vh-73px)] max-h-[calc(100vh-73px)] w-full px-4 md:px-8 flex flex-col overflow-auto">
        ...
        <div id="importacao" className="flex flex-col gap-3 py-4">
          ...
          <Tabs defaultValue="label-example" className="w-full">
        ...
        <div id="variantes" className="flex flex-col gap-3 py-4">
          ...
          <Tabs defaultValue="variants-example" className="w-full">
            ...
            <TabsContent value="variants-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{labelVariantsExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(labelVariantsExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="tamanhos" className="flex flex-col gap-3 py-4">
          ...
          <Tabs defaultValue="sizes-example" className="w-full">
            ...
            <TabsContent value="sizes-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{labelSizesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(labelSizesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="propriedades" className="flex flex-col gap-3 pt-4 pb-16">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                {" "}
                Propriedades para estilização do componente Label.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="properties-exemple" className="w-full">
            ...
            <TabsContent value="properties-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{labelPropertiesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(labelPropertiesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Define a aparência visual do label.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>default</Text>
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Controla o tamanho do label.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>md</Text>
                  </TableCell>
