...
export const paginationSizesExample = `<div className='flex flex-col gap-3'>
  {(["xs", "sm", "md", "lg", "xl"] as const).map((size) => (
    <Pagination key={size}>
      <PaginationContent>
        <PaginationItem>
          <PaginationPrevious size={size} variant='dark-ghost' href='#' />
        </PaginationItem>
        <PaginationItem>
          <PaginationLink size={size} variant='dark-ghost' href='#' isActive>
            1
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationLink size={size} variant='dark-ghost' href='#'>
            2
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
        ...
        <PaginationItem>
          <PaginationNext size={size} variant='dark-ghost' href='#' />
        </PaginationItem>
      </PaginationContent>
    </Pagination>
  ))}
...
export const paginationRoundedExample = `<div className='flex flex-col gap-3'>
  {(["xs", "sm", "md", "lg", "xl", "full"] as const).map((rounded) => (
    <Pagination key={rounded}>
      <PaginationContent>
        <PaginationItem>
          <PaginationPrevious rounded={rounded} variant='primary' href='#' />
        </PaginationItem>
        <PaginationItem>
          <PaginationLink rounded={rounded} variant='primary' href='#' isActive>
            1
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationLink rounded={rounded} variant='primary' href='#'>
            2
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
        ...
        <PaginationItem>
          <PaginationNext rounded={rounded} variant='primary' href='#' />
        </PaginationItem>
      </PaginationContent>
    </Pagination>
  ))}
...
export const paginationPropertiesExample = `<Pagination>
  <PaginationContent>
    <PaginationItem>
      <PaginationPrevious variant='default' size='md' rounded='md' href='#' />
    </PaginationItem>
    <PaginationItem>
      <PaginationLink
        variant='default'
    ...
    <PaginationItem>
      <PaginationLink variant='default' size='md' rounded='md' href='#'>
        2
      </PaginationLink>
    </PaginationItem>
    <PaginationItem>
    ...
    <PaginationItem>
      <PaginationNext variant='default' size='md' rounded='md' href='#' />
    </PaginationItem>
  </PaginationContent>
</Pagination>`;
