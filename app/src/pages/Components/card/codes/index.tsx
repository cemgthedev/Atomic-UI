export const cardExemple = `<Card variant="primary-ghost" size="md" className="min-w-0 max-w-xs">
  <CardHeader>
...
export const cardVariantsExemple = `<div className='flex justify-center flex-wrap gap-4'>
  {([
    ...
    <Card variant={variant} size='md' className='min-w-0 max-w-xs'>
      <CardHeader>
        <Image rounded='md' aspect='square' className='w-full h-40'>
          <ImageContent
            src='https://images.unsplash.com/photo-1500530855697-b586d89ba3ee'
...
export const cardSizesExemple = `<div className='flex justify-center flex-wrap gap-4'>
  {(["xs", "sm", "md", "lg", "xl"] as const).map((size) => (
    <Card variant='dark-bordered' size={size} className='min-w-0'>
      <CardHeader>
        <Image rounded='md' aspect='square' className='w-full h-40'>
          <ImageContent
            src='https://images.unsplash.com/photo-1500530855697-b586d89ba3ee'
...
export const cardRoundsExemple = `<div className='flex justify-center flex-wrap gap-4'>
  {(["xs", "sm", "md", "lg", "xl", "full"] as const).map((rounded) => (
    <Card variant='primary' rounded={rounded} className='min-w-0 max-w-sm'>
      <CardHeader>
        <Image rounded='md' aspect='square' className='w-full h-40'>
          <ImageContent
            src='https://images.unsplash.com/photo-1500530855697-b586d89ba3ee'
...
export const cardPropertiesExemple = `<Card variant='default' size='md' rounded='md' className='min-w-0 max-w-xs'>
  <CardHeader>
    <Image rounded='md' aspect='square' className='w-full h-40'>
      <ImageContent
        src='https://images.unsplash.com/photo-1500530855697-b586d89ba3ee'
