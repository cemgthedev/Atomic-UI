        ...
        <div id="variantes" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">Exemplos de variantes do botão.</Text>
            </div>
          </div>
        ...
        <div id="tamanhos" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">Exemplos de tamanhos do botão.</Text>
            </div>
          </div>
        ...
        <div id="arredondamentos" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Exemplos de arredondamentos do botão.
              </Text>
            </div>
          </div>
        ...
        <div id="propriedades" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                {" "}
                Propriedades para estilização do botão.
              </Text>
            </div>
          </div>
