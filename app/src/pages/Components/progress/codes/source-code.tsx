export const progressSourceCode = `import { cn } from "@/utils/cn";
import { cva, type VariantProps } from "class-variance-authority";

import { Progress as ProgressPrimitive } from "radix-ui";

const progressVariants = cva(
  "relative flex w-full overflow-hidden bg-muted",
  {
    variants: {
      variant: {
        default: "bg-muted",
...
export { Progress, progressVariants, ProgressValue, progressValueVariants };
export type { ProgressProps, ProgressValueProps };
`;
