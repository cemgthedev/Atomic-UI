...
import {
  messageExample,
  messagePropertiesExample,
  messageSizesExample,
  messageVariantsExample,
} from "@/pages/Components/message/codes";
import { messageSourceCode } from "@/pages/Components/message/codes/source-code";
...
export const sectionLinks: UrlProps[] = [
  {
    name: "Importação",
    href: `/${urls.components}/${urls.message}#importacao`,
  },
  {
    name: "Variantes",
    href: `/${urls.components}/${urls.message}#variantes`,
  },
  {
    name: "Tamanhos",
    href: `/${urls.components}/${urls.message}#tamanhos`,
  },
  {
    name: "Propriedades",
    href: `/${urls.components}/${urls.message}#propriedades`,
  },
];
        ...
        <div id="importacao" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            ...
            <Button
              ...
              variant="dark-ghost"
              onClick={() => copy(messageSourceCode)}
              className="min-w-fit"
            >
              Copiar código fonte
            </Button>
            ...
            <TabsContent value="message-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{messageExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(messageExample)}
        ...
        <div id="variantes" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Exemplos de variantes do componente Message.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="variants-example" className="w-full">
            ...
            <TabsContent value="variants-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{messageVariantsExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(messageVariantsExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="tamanhos" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Exemplos de tamanhos do componente Message.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="sizes-example" className="w-full">
            ...
            <TabsContent value="sizes-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{messageSizesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(messageSizesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="propriedades" className="flex flex-col gap-3 pt-4 pb-16">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Propriedades para estilização do componente Message.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="properties-example" className="w-full">
            ...
            <TabsContent value="properties-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{messagePropertiesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(messagePropertiesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Define a cor do texto da mensagem.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>default</Text>
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Controla o tamanho do texto da mensagem.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>md</Text>
                  </TableCell>
