...
import {
  textExample,
  textPropertiesExample,
  textSizesExample,
  textVariantsExample,
} from "@/pages/Components/text/codes";
import { textSourceCode } from "@/pages/Components/text/codes/source-code";
...
export const sectionLinks: UrlProps[] = [
  {
    name: "Importação",
    href: `/${urls.components}/${urls.text}#importacao`,
  },
  {
    name: "Variantes",
    href: `/${urls.components}/${urls.text}#variantes`,
  },
  {
    name: "Tamanhos",
    href: `/${urls.components}/${urls.text}#tamanhos`,
  },
  {
    name: "Propriedades",
    href: `/${urls.components}/${urls.text}#propriedades`,
  },
];
  ...
  return (
    <>
        ...
        <div id="variantes" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Exemplos de variantes do componente Text.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="variants-example" className="w-full">
            ...
            <TabsContent value="variants-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{textVariantsExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(textVariantsExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="tamanhos" className="flex flex-col gap-3 py-4">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                Exemplos de tamanhos do componente Text.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="sizes-example" className="w-full">
            ...
            <TabsContent value="sizes-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{textSizesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(textSizesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
        ...
        <div id="propriedades" className="flex flex-col gap-3 pt-4 pb-16">
          <div className="flex flex-col justify-between gap-4 lg:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <Text className="indent-8">
                {" "}
                Propriedades para estilização do componente Text.
              </Text>
            </div>
          </div>
          ...
          <Tabs defaultValue="properties-exemple" className="w-full">
            ...
            <TabsContent value="properties-code">
              <div className="w-full flex justify-between p-3 bg-muted-100 border border-muted-200 rounded-lg">
                <pre className="w-full overflow-auto scrollbar-thin mr-1">
                  <code>{textPropertiesExample}</code>
                </pre>
                <Button
                  startContent={<Copy size={20} className="text-zinc-600" />}
                  onClick={() => copy(textPropertiesExample)}
                  className="bg-transparent border-none p-0"
                />
              </div>
            </TabsContent>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Define a aparência visual do text.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>default</Text>
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Text>Controla o tamanho do text.</Text>
                  </TableCell>
                  <TableCell>
                    <Text>md</Text>
                  </TableCell>
      ...
      <aside className="hidden lg:flex flex-col gap-2 min-h-[calc(100vh-73px)] max-h-[calc(100vh-73px)] min-w-fit max-w-fit border-l border-muted-200 px-3 py-8 overflow-auto scrollbar-none">
        <Text size="sm" className="text-right px-3">
          Seções
        </Text>
